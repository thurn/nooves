...
- (void)viewDidLoad {
    ...
    UILabel *nooves = [[UILabel alloc] initWithFrame:CGRectMake(self.view.bounds.size.width/4-20, 150, 250, 70)];
    nooves.text = @"Nooves";
    [nooves setFont:[UIFont fontWithName:@"ProximaNova-Semibold" size:70]];
    ...
    loginButton.frame = CGRectMake(self.view.bounds.size.width/6, 240, 250, 30);
    
    UILabel *or = [[UILabel alloc] initWithFrame:CGRectMake(self.view.bounds.size.width/2-8, 280, 5, 5)];
    or.text = @"or";
    [or sizeToFit];
    [self.view addSubview:or];

    self.usernameField = [[UITextField alloc] initWithFrame:CGRectMake(self.view.bounds.size.width/6, 320, 250, 30)];
    ...
    self.passwordField = [[UITextField alloc] initWithFrame:CGRectMake(self.view.bounds.size.width/6, 360, 250, 30)];
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(self.view.bounds.size.width/6, 640, 20, 5)];
...
- (UIButton *)createLoginButton {
    ...
    button.frame = CGRectMake(self.view.bounds.size.width/6, 400, 250, 30);
